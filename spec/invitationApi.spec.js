...
let app = 'http://localhost:3000',
  ...
  user_token,
  invitations = {
    challenge: "594a3135635dd71fe98c55e6",
    players: ["5942a6f5e630441892a1f6eb", "5942a72be630441892a1f6ec"]
  };

describe('API invitation', function() {

  it("should  create invitation with sending mail", function(done) {
    request(app)
      .post('/invitations/')
      .send(
        invitations
      ...
      .end(function(err, res) {
        if (err) throw err;
        console.log(res);
        assert.equal(invitation.players.length, 2);
        done();
      });
  });
  //
  ...
  //     .send({
  //       community: "591ed337c2a0f36f30b37c21"
  //     })
  //     .expect(200)
  //     .end(function(err, res) {
  //       if (err) throw err;
